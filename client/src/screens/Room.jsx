...
const RoomPage = () => {
  ...
  const handleNegoNeeded = useCallback(async () => {
    ...
    console.log("Negotiation needed with offer:", offer);
  }, [remoteSocketId, socket]);
  ...
  const handleNegoNeedIncoming = useCallback(
    async ({ from, offer }) => {
      ...
      console.log("Negotiation needed incoming from:", from, "with offer:", offer);
    },
    [socket]
  );
  ...
  const handleNegoNeedFinal = useCallback(async ({ ans }) => {
    ...
    console.log("Negotiation final with answer:", ans);
  }, []);
